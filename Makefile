BUILD_DIRS=build.*
-include $(HOME)/.UnofficialOS/options
...
world: AMD64 RK3566-BSP RK3566-BSP-X55 RK3566-BSP-RGARC RK3588 S922X RK3326 RK3326-CLONE RK3399
...
RK3566-BSP-RGARC:
	DEVICE_ROOT=RK3566-BSP PROJECT=Rockchip DEVICE=RK3566-BSP-RGARC ARCH=arm ./scripts/build_distro
	DEVICE_ROOT=RK3566-BSP PROJECT=Rockchip DEVICE=RK3566-BSP-RGARC ARCH=aarch64 ./scripts/build_distro
...
# ${HOME}/.UnofficialOS/options is a global options file containing developer and build settings.
docker-%: GLOBAL_SETTINGS := $(shell if [ -f "${HOME}/.UnofficialOS/options" ]; then echo "-v \"${HOME}/.UnofficialOS/options:${HOME}/.UnofficialOS/options\""; else echo ""; fi)
