...
RUN if [ ! -d /lib64 ]; then ln -sf /usr/x86_64-unofficialos-linux-gnu/lib64 /lib64; fi
RUN if [ ! -d /lib/x86_64-unofficialos-linux-gnu ]; then ln -sf /usr/x86_64-unofficialos-linux-gnu/lib /lib/x86_64-unofficialos-linux-gnu; fi
