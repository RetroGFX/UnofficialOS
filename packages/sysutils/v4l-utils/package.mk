...
post_makeinstall_target() {
  ...
  if [ -n "$IR_REMOTE_PROTOCOLS" -a -n "$IR_REMOTE_KEYMAPS" ]; then
    create_multi_keymap unofficialos_multi "$IR_REMOTE_PROTOCOLS" $IR_REMOTE_KEYMAPS
